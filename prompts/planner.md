...
- **Prefer fewer, fuller children.** 4 children that each own a whole module are cheaper *and* higher quality than 7 that split hairs. Merge sibling fragments into one child before emitting.
